...
export default {
  ...
  data() {
    return {
      ...
      accessToken:"pk.eyJ1IjoibjBtM3JjeSIsImEiOiJjanBqNjd3eTMwMGUyM2twaWljYW16eHFkIn0.mPsNh8cCq7cgvZBb54F0aA",
      mapStyle: "mapbox://styles/n0m3rcy/cjrffq0f251df2snygznss0on", 
      lines: [],
      linesOnMap: 0,
      deleteLines: false
    };
